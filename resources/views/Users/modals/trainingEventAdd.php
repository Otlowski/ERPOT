<div id="modal-event-add" class="modal fade-in" data-test="training-event-lists" data-function="trainings-events-list">
        ...
        <div class="modal-content">
            <div class="modal-header modal-header--padding">
                ...
                <div class="modal-header__training-finish">Finish at  
                    <input type="text"  id="datetimepicker-finish" class="datetimepicker-finish" data-function="training-finish" style="pointer-events: none;"/>
                       <div class="datetimepicker-icon">
                            <span class="glyphicon glyphicon-calendar" style="top:3px;"></span>
                       </div>
                </div>
            ...
            <div class="modal-footer" data-function="modal-footer">
                ...
                <div class="table">
                    ...
                    <div class="row list">
                        ...
                        <div class="col-xs-5">
                            <button id="button-ok" type="button" class="btn btn-modal primary right" data-toggle="add-event">Add Event</button>
                        </div>
                    </div>
                </div>
