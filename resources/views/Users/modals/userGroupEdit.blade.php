<div id="modal-group-edit" data-modal="group-edit" class="modal modal-group-edit fade-in">
        ...
        <div class="modal-content">
            <div class="modal-header menu">
                <div class="row components tabview">
                    ...
                    <div class="col-xs-2 icon separate-line" data-content-name="user" data-tab-index="2">
                        <div class="img document"></div>
            ...
            <div class="modal-footer">
                ...
                <div class="table">
                    <div class="row">
                        <div class="col-xs-6">
                            <button data-toggle="modal-edit-delete" type="button" class="btn btn-modal left red">Delete room</button>
                        </div>
                        <div class="col-xs-6">
                            <button data-toggle="edit-cancel" type="button" class="btn btn-modal " data-dismiss="modal">Cancel</button>
                            <div class="separator line"></div>
                            <button data-toggle="modal-edit-save" type="button" class="btn btn-modal primary right">Save</button>
                        </div>
                    </div>
                </div>
