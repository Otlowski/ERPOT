<div id="modal-group-add" data-modal="group-add" class="modal modal-group-add fade-in">
                ...
                <div class="table">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            ...
                            <button data-toggle="modal-add-save" type="button" class="btn btn-modal primary right">Add group</button>
                        </div>
                    </div>
                </div>
