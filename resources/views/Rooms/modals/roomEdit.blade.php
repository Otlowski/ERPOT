<div id="modal-room-edit" data-modal="contract-edit" class="modal modal-room-edit fade-in">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="table">
                    <div class="row">
                        <div class="col-xs-6">
                            <button data-toggle="edit-delete" type="button" class="btn btn-modal left red">Delete room</button>
                        </div>
                        <div class="col-xs-6">
